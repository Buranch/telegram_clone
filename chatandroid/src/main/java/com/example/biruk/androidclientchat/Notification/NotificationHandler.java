...
public class NotificationHandler {
     ...
     */
    public void createSimpleNotification(Context context, String contentTitle, String contentText) {
        ...
        NotificationCompat.Builder mBuilder = new NotificationCompat.Builder(context)
                .setSmallIcon(R.drawable.red) // notification icon
                .setContentTitle(contentTitle) // main title of the notification
                .setContentText(contentText) // notification text
